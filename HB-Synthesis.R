...
#Inputs include hypothesized drivers of climate, precipitation chemistry, and three climate oscillation indices 
#located in the Original Data folder. Inputs also consist of calculated early warning signals for each response 
#variable from the Early Warning Signals Tables folder, as well as trends over time in early warning signals 
#(alltrends.csv) in the EWS Summary Tables folder. 

#Outputs include _Figure_2, Figure_3, Figure_4, and Figure_S4 in the manuscript, which are written to the EWS Summary 
#Figures folder. Outputs also consist of Kendall's Tau and associated p-values that compare early warning signals to 
#hypothesized drivers of climate and precipitation chemistry (EWS_regtab.csv) that form the basis of Tables S3-S6, 
